...
interface DynamicSheriffQuickPage1Props {
...
export function DynamicSheriffQuickPage1({ replayNonce }: DynamicSheriffQuickPage1Props) {
  ...
  return (
    ...
    >
      ...
      {/* Dynamic Content - Main objective */}
      <motion.div
